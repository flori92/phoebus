# jarvis/multi_user.py
"""
Reconnaissance multi-utilisateurs pour JARVIS.

Permet à Jarvis d'identifier qui parle et d'adapter ses réponses.
...
Approche :
  ...
  4. Sinon : "inconnu" → Jarvis utilise le comportement par défaut.

Variables d'environnement :
  JARVIS_MULTI_USER=1           → active la reconnaissance (désactivé par défaut)
  JARVIS_SPEAKER_THRESHOLD=0.75 → seuil de confiance (0.0–1.0)
...
MULTI_USER_ENABLED   = os.getenv("JARVIS_MULTI_USER", "0").strip() == "1"
SPEAKER_THRESHOLD    = float(os.getenv("JARVIS_SPEAKER_THRESHOLD", "0.75"))
PROFILES_DIR         = BASE_DIR / "jarvis_speaker_profiles"
