"""Clarification / auto-correction de JARVIS.

Deux responsabilités :
1. Détecter qu'une transcription micro est probablement cassée / incomprise
   (trop courte, mot seul, charabia) afin que Jarvis redemande plutôt
   que d'inventer.
2. Détecter qu'une demande est ambiguë avant de déclencher une action,
   pour que Jarvis pose une question de clarification courte.
"""
import re
