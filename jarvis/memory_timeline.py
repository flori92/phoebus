# jarvis/memory_timeline.py
"""
Mémoire long terme enrichie de JARVIS — Timeline + Résumés automatiques.

Trois couches complémentaires :
  1. Timeline JSON  — événements horodatés, persiste dans jarvis_timeline.json
...
from jarvis.config import BASE_DIR, client, types, CHOSEN_MODEL

# ── Chemins ───────────────────────────────────────────────────────────────────

TIMELINE_FILE   = BASE_DIR / "jarvis_timeline.json"
PROFILE_FILE    = BASE_DIR / "jarvis_profile.json"
