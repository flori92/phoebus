...
async def agent_vision_active() -> str:
    ...
    try:
        ...
        path_ss = "PHOEBUS_agent_vision_temp.png"
...
async def orchestrer_agent_autonome(instruction: str) -> str:
    ...
    agent_prompt = """Tu es l'agent système natif de PHOEBUS. Tu possèdes un contrôle TOTAL sur la machine hôte.
    ...
    for etape in range(10):  # Limite de sécurité anti-boucle infinie
        try:
            ...
            if action == "terminer":
                ...
                with open("PHOEBUS_tmp_script.py", "w") as f:
                    f.write(code)
                res = executer_commande_shell("python3 PHOEBUS_tmp_script.py")
                os.remove("PHOEBUS_tmp_script.py")
