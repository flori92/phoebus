...
def construire_system_prompt(texte_utilisateur="", minimal=False):
    ...
    if minimal:
        ...
        base = (
            ...
            "⚡ EFFICACITÉ, PROACTIVITÉ ET AUTO-AMÉLIORATION :\n"
            ...
            "- 🛠️ AUTO-AMÉLIORATION : Si tu te rends compte qu'une commande a échoué (ex: mot-clé manquant dans intent.py, "
            "skill imparfait), UTILISE TES SKILLS DÉVELOPPEUR (`terminal_run`, `skill_create`, `python_run`) "
            "pour lire et CORRIGER TON PROPRE CODE (dans PHOEBUS/intent.py ou PHOEBUS/skills/). Tu as la capacité et le "
            "devoir de t'auto-améliorer en temps réel si tu vois une faille.\n"
