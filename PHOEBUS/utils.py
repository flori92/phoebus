# PHOEBUS/utils.py
"""Utilitaires système partagés par les modules PHOEBUS."""
import os
import re
import shutil
import socket
...
from PHOEBUS.config import IS_WINDOWS, IS_MACOS, SYSTEM_NAME
...
def terminate_process_tree(process):
    ...
    try:
        ...
        print(f"[PHOEBUS] Impossible d'arreter le processus enfant : {e}")
